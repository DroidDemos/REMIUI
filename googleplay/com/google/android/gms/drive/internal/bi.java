...
public class bi implements Creator<UpdateMetadataRequest> {
    static void a(UpdateMetadataRequest updateMetadataRequest, Parcel parcel, int i) {
        int bU = b.bU(parcel);
        b.c(parcel, 1, updateMetadataRequest.mVersionCode);
        b.a(parcel, 2, updateMetadataRequest.Zc, i, false);
        b.a(parcel, 3, updateMetadataRequest.Zd, i, false);
        b.J(parcel, bU);
    }
    ...
    public UpdateMetadataRequest da(Parcel parcel) {
    ...
    public UpdateMetadataRequest[] eI(int i) {
