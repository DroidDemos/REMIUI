...
public class a implements Creator<AccessKey> {
    static void a(AccessKey accessKey, Parcel parcel, int i) {
        int bU = b.bU(parcel);
        b.c(parcel, 1, accessKey.getVersionCode());
    ...
    public AccessKey fl(Parcel parcel) {
