...
public class a implements Creator<TestDataImpl> {
    static void a(TestDataImpl testDataImpl, Parcel parcel, int i) {
        int bU = b.bU(parcel);
        b.a(parcel, 1, testDataImpl.getTestName(), false);
        b.c(parcel, 1000, testDataImpl.mVersionCode);
        b.J(parcel, bU);
    }
    ...
    public TestDataImpl ga(Parcel parcel) {
