...
public class PaypalPasswordEncryptor {
    private final String mHashedDeviceId;

    public PaypalPasswordEncryptor(Context context, String deviceIdSalt) {
        this.mHashedDeviceId = getHashedDeviceId(Secure.getString(context.getContentResolver(), "android_id"), deviceIdSalt);
    }

    public String encryptPassword(byte[] certificateBytes, String password) throws CertificateException {
        return encryptPassword(certificateBytes, password, getHashedDeviceId(), System.currentTimeMillis());
    }
    ...
    String encryptPassword(byte[] certificateBytes, String password, String hashedDeviceId, long timestampMs) throws CertificateException {
        return Base64.encodeToString(encrypt(getX509Certificate(certificateBytes), timestampMs, hashedDeviceId, password), 2);
    }

    static String getHashedDeviceId(String deviceId, String deviceIdSalt) {
        try {
    ...
    byte[] encrypt(X509Certificate certificate, long timestampMs, String hashedDeviceId, String password) throws CertificateException {
        ...
        return createEncryptedPayload(certificateSerialNumber, encryptExchangeKey(certificate, exchangeKey), encryptInnerMessage(exchangeKey, createInnerMessage(timestampMs, hashedDeviceId, password)));
    }
    ...
    private byte[] createInnerMessage(long timestampMs, String hashedDeviceId, String password) {
