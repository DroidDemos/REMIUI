...
public class ForegroundRelativeLayout extends RelativeLayout {
    ...
    public void setForegroundPadding(int foregroundPaddingLeft, int foregroundPaddingTop, int foregroundPaddingRight, int foregroundPaddingBottom) {
        this.mForegroundPaddingLeft = foregroundPaddingLeft;
        this.mForegroundPaddingTop = foregroundPaddingTop;
        this.mForegroundPaddingRight = foregroundPaddingRight;
        this.mForegroundPaddingBottom = foregroundPaddingBottom;
        requestLayout();
        invalidate();
    }
