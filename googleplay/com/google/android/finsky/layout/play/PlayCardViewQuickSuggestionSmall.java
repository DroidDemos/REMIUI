...
public class PlayCardViewQuickSuggestionSmall extends PlayCardViewSmall implements AnimationListener, PendingStateHandler {
    ...
    public PlayCardViewQuickSuggestionSmall(Context context, AttributeSet attrs) {
        super(context, attrs);
