...
public class PassportHostInfo implements TBase<PassportHostInfo, _Fields>, Serializable, Cloneable {
    private static final TField HOST_FIELD_DESC;
    private static final TField LAND_NODE_INFO_FIELD_DESC;
    private static final TStruct STRUCT_DESC;
    public static final Map<_Fields, FieldMetaData> metaDataMap;
    private String host;
    private List<PassportLandNodeInfo> land_node_info;

    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$xiaomi$common$logger$thrift$mfs$PassportHostInfo$_Fields;

        static {
            $SwitchMap$com$xiaomi$common$logger$thrift$mfs$PassportHostInfo$_Fields = new int[_Fields.values().length];
            try {
                $SwitchMap$com$xiaomi$common$logger$thrift$mfs$PassportHostInfo$_Fields[_Fields.HOST.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$xiaomi$common$logger$thrift$mfs$PassportHostInfo$_Fields[_Fields.LAND_NODE_INFO.ordinal()] = 2;
    ...
    static {
        STRUCT_DESC = new TStruct("PassportHostInfo");
        ...
        tmpMap.put(_Fields.LAND_NODE_INFO, new FieldMetaData("land_node_info", (byte) 1, new ListMetaData(TType.LIST, new StructMetaData(TType.STRUCT, PassportLandNodeInfo.class))));
        metaDataMap = Collections.unmodifiableMap(tmpMap);
        FieldMetaData.addStructMetaDataMap(PassportHostInfo.class, metaDataMap);
    }

    public PassportHostInfo(String host, List<PassportLandNodeInfo> land_node_info) {
        this();
        this.host = host;
        this.land_node_info = land_node_info;
    }

    public PassportHostInfo(PassportHostInfo other) {
        if (other.isSetHost()) {
            this.host = other.host;
        }
        if (other.isSetLand_node_info()) {
            List<PassportLandNodeInfo> __this__land_node_info = new ArrayList();
            for (PassportLandNodeInfo other_element : other.land_node_info) {
                __this__land_node_info.add(new PassportLandNodeInfo(other_element));
            }
            this.land_node_info = __this__land_node_info;
        }
    }

    public PassportHostInfo deepCopy() {
        return new PassportHostInfo(this);
    }
    ...
    public PassportHostInfo setHost(String host) {
        this.host = host;
        return this;
    }
    ...
    public Iterator<PassportLandNodeInfo> getLand_node_infoIterator() {
        return this.land_node_info == null ? null : this.land_node_info.iterator();
    }

    public void addToLand_node_info(PassportLandNodeInfo elem) {
    ...
    public List<PassportLandNodeInfo> getLand_node_info() {
        return this.land_node_info;
    }

    public PassportHostInfo setLand_node_info(List<PassportLandNodeInfo> land_node_info) {
        this.land_node_info = land_node_info;
        return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
        switch (AnonymousClass1.$SwitchMap$com$xiaomi$common$logger$thrift$mfs$PassportHostInfo$_Fields[field.ordinal()]) {
            case TTransportException.NOT_OPEN /*1*/:
                if (value == null) {
                    unsetHost();
                    return;
    ...
    public boolean equals(Object that) {
        if (that != null && (that instanceof PassportHostInfo)) {
            return equals((PassportHostInfo) that);
        }
        return false;
    }

    public boolean equals(PassportHostInfo that) {
        if (that == null) {
            return false;
        }
    ...
    public int compareTo(PassportHostInfo other) {
        if (!getClass().equals(other.getClass())) {
            return getClass().getName().compareTo(other.getClass().getName());
        }
        PassportHostInfo typedOther = other;
        ...
        while (true) {
            ...
            switch (field.id) {
                ...
                case TTransportException.ALREADY_OPEN /*2*/:
                    ...
                    this.land_node_info = new ArrayList(_list18.size);
                    for (int _i19 = 0; _i19 < _list18.size; _i19++) {
                        PassportLandNodeInfo _elem20 = new PassportLandNodeInfo();
                        _elem20.read(iprot);
                        this.land_node_info.add(_elem20);
                    }
                    iprot.readListEnd();
                    break;
                default:
    ...
    public void write(TProtocol oprot) throws TException {
        ...
        if (this.land_node_info != null) {
            ...
            for (PassportLandNodeInfo _iter21 : this.land_node_info) {
                _iter21.write(oprot);
            }
            oprot.writeListEnd();
            oprot.writeFieldEnd();
