...
public class XmPushActionUnRegistrationResult implements TBase<XmPushActionUnRegistrationResult, _Fields>, Serializable, Cloneable {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields;

        static {
            $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields = new int[_Fields.values().length];
            try {
                $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields[_Fields.DEBUG.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields[_Fields.TARGET.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields[_Fields.ID.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields[_Fields.APP_ID.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields[_Fields.REQUEST.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields[_Fields.ERROR_CODE.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields[_Fields.REASON.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                $SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields[_Fields.PACKAGE_NAME.ordinal()] = 8;
    ...
    static {
        ...
        tmpMap.put(_Fields.REQUEST, new FieldMetaData("request", (byte) 2, new StructMetaData(TType.STRUCT, XmPushActionUnRegistration.class)));
    ...
    public XmPushActionUnRegistrationResult(String id, String appId, long errorCode) {
        this();
        this.id = id;
        this.appId = appId;
    ...
    public XmPushActionUnRegistrationResult(XmPushActionUnRegistrationResult other) {
        this.__isset_bit_vector = new BitSet(1);
        ...
        if (other.isSetRequest()) {
            this.request = new XmPushActionUnRegistration(other.request);
        }
    ...
    public XmPushActionUnRegistrationResult setDebug(String debug) {
        this.debug = debug;
        return this;
    }
    ...
    public XmPushActionUnRegistrationResult setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public XmPushActionUnRegistrationResult setAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public XmPushActionUnRegistration getRequest() {
        return this.request;
    }

    public XmPushActionUnRegistrationResult setRequest(XmPushActionUnRegistration request) {
    ...
    public XmPushActionUnRegistrationResult setErrorCode(long errorCode) {
        this.errorCode = errorCode;
        setErrorCodeIsSet(true);
        return this;
    }
    ...
    public XmPushActionUnRegistrationResult setReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public XmPushActionUnRegistrationResult setPackageName(String packageName) {
    ...
    public void setFieldValue(_Fields field, Object value) {
        switch (AnonymousClass1.$SwitchMap$com$xiaomi$xmpush$thrift$XmPushActionUnRegistrationResult$_Fields[field.ordinal()]) {
            case TTransportException.NOT_OPEN /*1*/:
                if (value == null) {
                    unsetDebug();
                    return;
            ...
            case TProtocolException.NOT_IMPLEMENTED /*5*/:
                if (value == null) {
                    ...
                    setRequest((XmPushActionUnRegistration) value);
                    return;
                }
            case TApplicationException.INTERNAL_ERROR /*6*/:
                if (value == null) {
