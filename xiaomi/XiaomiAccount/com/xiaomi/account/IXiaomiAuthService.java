        ...
        private static class Proxy implements IXiaomiAuthService {
            ...
            public Bundle getMiCloudUserInfo(Account account, Bundle options) throws RemoteException {
                ...
                try {
                    ...
                    if (account != null) {
                        _data.writeInt(Stub.TRANSACTION_getMiCloudUserInfo);
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getMiCloudUserInfo, _data, _reply, 0);
            ...
            public Bundle getMiCloudAccessToken(Account account, Bundle options) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getMiCloudAccessToken, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (Bundle) Bundle.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public Bundle getSnsAccessToken(Account account, Bundle options) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getSnsAccessToken, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (Bundle) Bundle.CREATOR.createFromParcel(_reply);
                    } else {
            ...
            public void invalidateAccessToken(Account account, Bundle options) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_invalidateAccessToken, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case TRANSACTION_getMiCloudUserInfo /*1*/:
                    ...
                    if (_result != null) {
                        reply.writeInt(TRANSACTION_getMiCloudUserInfo);
                        _result.writeToParcel(reply, TRANSACTION_getMiCloudUserInfo);
                        return true;
                    }
                    reply.writeInt(0);
                    return true;
