...
public class s implements Serializable, Cloneable, TBase {
    ...
    static {
        zG = new f("XmPushActionUnSubscription");
    ...
    public int b(s sVar) {
        ...
        if (a()) {
            compareTo = org.apache.thrift.b.f(this.a, sVar.a);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (c()) {
            compareTo = org.apache.thrift.b.f(this.c, sVar.c);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (d()) {
            compareTo = org.apache.thrift.b.f(this.d, sVar.d);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (e()) {
            compareTo = org.apache.thrift.b.f(this.e, sVar.e);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (f()) {
            compareTo = org.apache.thrift.b.f(this.f, sVar.f);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (g()) {
            compareTo = org.apache.thrift.b.f(this.g, sVar.g);
            if (compareTo != 0) {
                return compareTo;
            }
        }
    ...
    public s bO(String str) {
        this.d = str;
        return this;
    }

    public s bP(String str) {
        this.e = str;
        return this;
    }

    public s bQ(String str) {
        this.f = str;
        return this;
    }
