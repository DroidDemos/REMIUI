...
public class b {
    public static String a(String str) {
        try {
            return String.valueOf(a.d(MessageDigest.getInstance("SHA1").digest(str.getBytes("UTF-8"))));
        } catch (Throwable e) {
            com.xiaomi.f.a.c.b.b("CloudCoder.hash4SHA1 ", e);
            throw new IllegalStateException("failed to SHA1");
        } catch (Throwable e2) {
            com.xiaomi.f.a.c.b.b("CloudCoder.hash4SHA1 ", e2);
            throw new IllegalStateException("failed to SHA1");
        }
    }
