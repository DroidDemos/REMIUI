...
public class D extends cs {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mClearButton.setOnClickListener(new l(this));
        this.DJ = new b();
        this.qm = new d();
        this.qm.a(this.DJ);
        ...
        this.qo.addTextChangedListener(new g());
        this.qo.addTextChangedListener(new H());
        this.qo.setOnItemClickListener(new m(this));
        this.qo.setOnClickListener(new n(this));
    ...
    public void onStart() {
        super.onStart();
        bI();
        this.qo.addTextChangedListener(this.DK);
    }
    ...
    public void onStop() {
        super.onStop();
        dc();
        this.qo.removeTextChangedListener(this.DK);
    }
    ...
    private void B(int i) {
        if (i >= Sim.getSimCount(this.mActivity)) {
            Log.d("MiPayRechargeFragment", "Index out of bounds: " + i);
        } else {
            ThreadPool.execute(new h(this, i));
        }
    }

    private void cU() {
        this.qF = new o(this.mActivity);
        this.qF.a(new i(this));
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        this.DH = new e();
        getLoaderManager().initLoader(1, null, this.DH);
        this.mRequestLoader = new d();
        this.DM = new F();
        this.DI = new w();
        this.mRequestLoader.a(this.hh);
        this.mRequestLoader.a(this.DI);
    }
    ...
    private BaseRequest cW() {
        HttpRequest httpRequest = new HttpRequest(this.mActivity, HostManager.getMiPayRechargeProductUrl(), 1);
    ...
    private BaseRequest cX() {
        b da = da();
        HttpRequest httpRequest = new HttpRequest(this.mActivity, HostManager.getMiPayRechargePriceUrl(), da.hashCode());
    ...
    private BaseRequest cY() {
        HttpRequest httpRequest = new HttpRequest(this.mActivity, HostManager.getMiPayRechargeOrderUrl(), 2);
        httpRequest.addParam("recharge_name", normalizeNumber(this.qo.getText().toString()));
    ...
    private BaseRequest at(String str) {
        HttpRequest httpRequest = new HttpRequest(this.mActivity, HostManager.getMiPayRechargeOrderInfoUrl(), 4);
    ...
    private BaseRequest S(String str) {
        HttpRequest httpRequest = new HttpRequest(this.mActivity, HostManager.getMiPayRechargeSecurityPayUrl(), 3);
        httpRequest.addParam("order_id", str);
        httpRequest.setRequestCache(false);
        httpRequest.setRequireLogin(true);
        return httpRequest;
    ...
    private void cZ() {
        if (this.DL != null) {
            ...
            int size = this.DL.DO.size();
            int i = 0;
            while (i < size) {
                b bVar = (b) this.DL.DO.get(i);
    ...
    private String normalizeNumber(String str) {
        ...
        parse.recycle();
        Log.d("MiPayRechargeFragment", "The recharge phone number is " + effectiveNumber);
        return effectiveNumber;
    }

    private b da() {
        return (b) this.DL.DO.get(this.qp.getCheckedRadioButtonId());
    }
    ...
    private void db() {
        ...
        z zVar = new z(this, new SpannableStringBuilder());
        zVar.a('1', normalizeNumber);
        zVar.a('2', this.qG.Y());
        zVar.a('3', this.DM.lB);
        new Builder(this.mActivity).setTitle(R.string.recharge_user_confirm_title).setMessage(zVar.P(string)).setIconAttribute(16843605).setNegativeButton(17039360, null).setPositiveButton(17039370, new L(this, normalizeNumber)).show();
        r(true);
    }
    ...
    private void aw(String str) {
        for (String str2 : str.split(";")) {
            ...
            this.qm.a(b(str2, 6), new x(this, str2));
        }
        this.qF.updateData(this.qA);
    }
